...
------------------------------------------------------------
Wszystkie strony dostępne dla użytkownika niezalogowanego umożliwiają przejście
do strony głównej, formularza logowania, rejestracji oraz do strony wyświetlającej
stan stacji zawartych w bazie danych. --%>
...
<main>
    <div id="wrapper">
        ...
        <br>
        <div class="joinUs">
            <a href="station-status-redirect">Zobacz gdzie jesteś potrzebny i podaruj życie!</a>
        </div>

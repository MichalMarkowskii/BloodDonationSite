...
<%--STRONA REJESTRACJI - UŻYTKOWNIK NIEZALOGOWANY
Jest to strona wyświetlająca formularz umożliwiający zarejestrowanie się. --%>
...
<form method="post" action="register">
    <input type="text" id="fname" name="fname" placeholder="Imię"><br><br>
    <input type="text" id="lname" name="lname" placeholder="Nazwisko"><br><br>
    ...
    <input type="password" id="adminCode" name="adminCode" placeholder="Kod administratora"><br><br>

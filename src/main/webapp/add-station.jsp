...
<%--STRONA DODAWANIA STACJI - ADMINISTRATOR
Jest to strona wyświetlająca formularz umożliwiający dodanie nowej stacji
do bazy danych. --%>
...
<h1>Dodaj stację krwiodawstwa</h1>
...
<main>
    <div id="wrapper">
        ...
        <form action="add-station">
            <input type="text" id="rckik" name="rckik" placeholder="RCKiK"><br><br>
            <input type="text" id="adress" name="adress" placeholder="Adres"><br><br>
            <input type="text" id="city" name="city" placeholder="Miejscowość"><br><br>
            <input type="tel" pattern="[0-9]{9}" id="phone" name="phone" placeholder="Numer telefonu"><br><br>
            <input type="url" id="webpage" name="webpage" placeholder="Adres strony www"><br><br>
            <input type="submit" value="Dodaj stację" class="button">
        </form>
    </div>
</main>
</body>

...
@WebServlet(name = "StationServletAdmin", value = "/station-status-li-redirect")
public class StationServletAdmin extends HttpServlet {

    /**
     * Metoda pobierająca dane z bazy o szczegółach stacji i statusie krwi, oraz przekierowująca do widoku administratora.
     *
